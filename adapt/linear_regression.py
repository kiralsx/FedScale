...
dataloader.autoscale_batch_size(args.bs, local_bsz_bounds=local_bsz_bounds) # Changed in step 3, optional
...
for epoch in adl.remaining_epochs_until(args.epochs):
    ...
    for inputs, targets in dataloader: 
        ...
        # print(batch_stat)
        print(f"epoch: {epoch}, bsz: {dataloader.current_batch_size}")
